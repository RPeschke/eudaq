...
namespace IMPL {
   ...
   */
   class DLLEXPORT_LCIO PIDSort : public std::binary_function<EVENT::ParticleID*,EVENT::ParticleID*,bool>{
  public:
 ...
 */
   ...
   class DLLEXPORT_LCIO ParticleIDImpl : public EVENT::ParticleID, public AccessChecked {
