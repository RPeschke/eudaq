...
namespace UTIL{
   ...
   */
  template <class T>
  DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit()  { return -1; }

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::SimCalorimeterHit>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::RawCalorimeterHit>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::CalorimeterHit>() ; 

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::TrackerData>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::TrackerPulse>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::TrackerRawData>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::TrackerHit>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::TrackerHitPlane>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::TrackerHitZCylinder>() ;

  /** specialization that returns the proper bit for the second cellid */
  template<> DLLEXPORT_LCIO int CellIDEncoder_cellID1Bit<EVENT::SimTrackerHit>() ;
...
//
   ...
   */
  template <class T> 
  class  DLLEXPORT_LCIO CellIDEncoder : public BitField64 {
