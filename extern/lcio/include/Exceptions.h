...
namespace EVENT {
   ...
   */
   ...
   class DLLEXPORT_LCIO Exception : public std::exception {
   ...
   * @version Apr 30, 2003
   */
   class DLLEXPORT_LCIO EventException : public Exception{
   ...
   * @version Jun 5, 2003
   */
   class DLLEXPORT_LCIO DataNotAvailableException : public EventException{
   ...
   * @version Jun 5, 2003
   */
   class DLLEXPORT_LCIO ReadOnlyException : public EventException{
...
namespace IO {
   ...
   * @version Apr 30, 2003
   */
   class DLLEXPORT_LCIO IOException : public EVENT::Exception{
   ...
   * @version Jun 5, 2003
   */
   class DLLEXPORT_LCIO EndOfDataException : public IOException{
  public: 
