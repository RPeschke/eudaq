...
namespace lcrtrel{
  ...
  template <class U, class T> 
   class DLLEXPORT_LCIO LCExtensionVector :
   ...
   */
  template <class U, class T> 
   class DLLEXPORT_LCIO LCOwnedExtensionVector : 
    public LCBaseLinkContainerTraits< U, std::vector<T*>,
				      CreationPtrInit< std::vector<T*> > , 
  ...
  template <class U, class T> 
   class DLLEXPORT_LCIO LCExtensionList :
    public LCBaseLinkContainerTraits< U, std::list<T*>,
				      CreationPtrInit< std::list<T*> > , 
   ...
   */
  template <class U, class T> 
   class DLLEXPORT_LCIO LCOwnedExtensionList : 
    public LCBaseLinkContainerTraits< U, std::list<T*>,
				      CreationPtrInit< std::list<T*> > , 
  ...
  class  DLLEXPORT_LCIO  LCRTRelations{
