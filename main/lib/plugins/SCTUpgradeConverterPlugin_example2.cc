...
namespace eudaq {
  ...
  static const char* EVENT_TYPE = "sct2";
  static const char* LCIO_collection_name= "zsdata_strip";


  // Declare a new class that inherits from DataConverterPlugin
  class SCTupgradeConverterPlugin_sct2 : public DataConverterPlugin {
  ...
  private:
    ...
    SCTupgradeConverterPlugin_sct2(): DataConverterPlugin(EVENT_TYPE){}

    const int m_plane_id = 9;
    // The single instance of this converter plugin
    static SCTupgradeConverterPlugin_sct2 m_instance;
  }; // class ExampleConverterPlugin

  // Instantiate the converter plugin instance
  SCTupgradeConverterPlugin_sct2 SCTupgradeConverterPlugin_sct2::m_instance;
