...
namespace eudaq {
  ...
  */
  ...
  public:
    typedef std::pair<uint64_t,uint64_t> t_eventid;
    ...
    */
    ...
    static t_eventid getEventId(eudaq::AidaPacket const & ev);
