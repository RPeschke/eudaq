...
#ifndef EUTelSCTDetector_h
#define EUTelSCTDetector_h
...
namespace eutelescope {
  ...
  const static char* SCTUPCollectionName ="SCTUpgrade";

  class EUTelSCTDetector : public EUTelPixelDetector {
